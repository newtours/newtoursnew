...
for ($i=0;$i<(count($file_names)-2);$i++)
{
  ...
  $tour_names_data[$i]["tour_rowid"]=$tour_rowid;
...
{
  $tour_rowid=$tour_names_data[$i]["tour_rowid"];
  ...
  <td style=\"padding-left:5px\" width='45%' align='center'><a  href=\"stars.php?tour_id=$id#ezine-abstracts\" title=\"Описание тура\">$name</a></td>
  ...
  <td style=\"padding-left:5px\" align='center'><a  href=\"/new-tours/regular.php?reg_id=95\" title=\"Описание тура\">ВСЯ КАНАДА – ОТ ОКЕАНА ДО ОКЕАНА <br/>(Тур без заезда в США)</a></td>
  ...
  <td><a class=\"sublnk\" href=\"../new-tours/order_tour.php?ord_tour=146\" >Заказать</a></td></tr>");

  print ("<tr  style=\"font-color:#000080;BACKGROUND:BACKGROUND:#ffffcc\">
  <td style=\"padding-left:5px\" align='center'><a  href=\"/new-tours/regular.php?reg_id=96\" title=\"Описание тура\">ВСЯ КАНАДА – ОТ ОКЕАНА ДО ОКЕАНА <br/>(с заездом  в США - Нью-Йорк)</a></td>
  ...
  <td><a class=\"sublnk\" href=\"../new-tours/order_tour.php?ord_tour=147\" >Заказать</a></td></tr>");

  print ("<tr  style=\"font-color:#000080;BACKGROUND:BACKGROUND:#ffffcc\">
  <td style=\"padding-left:5px\" align='center'><a  href=\"/new-tours/regular.php?reg_id=97\" title=\"Описание тура\">ВСЯ КАНАДА – ОТ ОКЕАНА ДО ОКЕАНА <br/>(с заездом  в США - Нью-Йорк - Сиэтл)</a></td>
  ...
  <td><a class=\"sublnk\" href=\"../new-tours/order_tour.php?ord_tour=148\" >Заказать</a></td></tr>");
